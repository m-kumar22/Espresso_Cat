...
gsap.from("#section2 #fourth .small",{
    scrollTrigger:{
        scroller:"body",
        trigger:"#section2 #fourth .small",
        start:"top 80%",
        // markers:true
    },
    ease:Expo.easeInOut,
...
gsap.from("#section2 #fourth .big h1",{
    scrollTrigger:{
        scroller:"body",
        trigger:"#section2 #fourth .big h1",
        start:"top 80%",
        // markers:true
    },
    opacity:0,
...
gsap.from("#section2 #fourth .big p",{
    scrollTrigger:{
        scroller:"body",
        trigger:"#section2 #fourth .big p",
        start:"top 80%",
        // markers:true
    },
    opacity:0,
